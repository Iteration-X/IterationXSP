...
1. **Access Iteration X Dashboard**: Visit [app.iterationx.com](https://app.iterationx.com/login?redirect=%2Fdashboard). Log in with your credentials if you're not already signed in.
